...
<span class="fhir-conformance" id="versioning-1">While out of scope for this IG, good practice suggests that where revision scenarios are possible, those resources subject to revision <b>SHOULD</b> carry a persistent resource identifier (.identifier).</span> 
